...
local function createMyParagraphStats()
    ...
    local agilityStat = leaderstats:WaitForChild("Agility")
    local killsStat = leaderstats:WaitForChild("Kills")
    local evilKarmaStat = leaderstats:WaitForChild("evilKarma")
    local goodKarmaStat = leaderstats:WaitForChild("goodKarma")
